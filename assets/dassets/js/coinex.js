...
function copyNumber() {
  const number = document.getElementById("number-span").innerText;
  navigator.clipboard.writeText(number);
  alert("Account Number Copied!");
}

function copyWallet() {
  const wallet = document.getElementById("wallet-span").innerText;
  navigator.clipboard.writeText(wallet);
  alert("Wallet Number Copied!");
}

function copyReferral() {
  const referral = document.getElementById("referral-span").innerText;
  navigator.clipboard.writeText(referral);
  alert("Referral ID Copied!");
}

function copyReferralLink() {
  const referrallink = document.getElementById("referrallink-span").innerText;
