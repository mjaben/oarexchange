...
<div class="container-fluid content-inner pb-0">
    <div class="row">
        ...
        >
        <form method="GET" action="{{route('user.update', auth()->user()->id)}}" enctype="multipart/form-data" class="identity-upload">
            @csrf
            {{-- @method('PUT') --}}
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                {{-- <div
                                    class="profile-img-edit position-relative"
                                >
                                    <img
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <input
                                    type="file"
                                    class="form-control"
                                    id="floatingcoverImage"
                                    placeholder="Upload Cover Image"
                                />
                                <label for="floatingcoverImage"
